...
import GUI.FormQuanLy.BanHangForm;
import GUI.FormQuanLy.BeginForm;
import GUI.FormQuanLy.EmptyPage;
import GUI.FormQuanLy.NhapHangForm;
import GUI.FormQuanLy.QuanLyNhaCungCapForm;
import GUI.FormQuanLy.QuanLyHoaDonForm;
import GUI.FormQuanLy.QuanLySanPhamForm;
import GUI.FormQuanLy.QuanLyKhachHangForm;
import GUI.FormQuanLy.QuanLyKhuyenMaiForm;
import GUI.FormQuanLy.QuanLyLoaiSanPhamForm;
import GUI.FormQuanLy.QuanLyNhanVienForm;
import GUI.FormQuanLy.QuanLyPhieuNhapForm;
import GUI.FormQuanLy.QuanLyQuyenForm;
import GUI.FormQuanLy.QuanLyTaiKhoanForm;
import GUI.FormQuanLy.ThongKe.ThongKeForm;
import GUI.NavBar.NavBarButton;
import GUI.NavBar.NavBarContainer;
import GUI.NavBar.NavBarSeperator;
import GUI.NavBar.NavBarTitle;
...
public class GiaoDienChuan extends JFrame implements MouseListener {
    ...
    public GiaoDienChuan() {
      ...
      //  int headerBg = 30;
        int headerH = 55;
        header = new NavBarContainer(new Rectangle(0, 0, WIDTH-100, headerH));
        header.setBackground(new Color(0,0,51));

        headerTitle = new NavBarTitle(new Rectangle((WIDTH - 400) / 2, 0, 400, headerH), "LAPTOP STORE");
        headerTitle.setColorDefault(new Color(200, 200, 200));
        headerTitle.setBgDefault(new Color(0,0,51));
        ...
        btnClose.setBgDefault(new Color(0,0,51));
...
//         ========= Draggable ===========
        ...
        plContent.setBackground(Color.white);
