...
import BackEnd.QuanLyKhuyenMai.QuanLyKhuyenMaiBUS;
import BackEnd.QuanLyLoaiSanPham.QuanLyLoaiSanPhamBUS;
import BackEnd.QuanLyNCC.NhaCungCap;
...
import GUI.FormChon.ChonKhuyenMaiForm;
...
import GUI.MyButton.RefreshButton;
...
class PhieuNhapHang extends FormHang {
    ...
    public PhieuNhapHang(int _x, int _y, int _width, int _height) {
        ...
        plSanPham.setBackground(Color.white);
        ...
        plButtonChiTiet.setBackground(Color.white);
        ...
        plThanhToan.setBackground(Color.white);
