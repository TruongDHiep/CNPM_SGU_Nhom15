...
import GUI.FormChon.ChonLoaiSanPhamForm;
import GUI.MyButton.FileButton;
...
public class ThemSuaSanPhamForm extends JFrame {
    ...
    public ThemSuaSanPhamForm(String _type, String _masp) {
        ...
        plChonAnh.setBackground(Color.white);
        plChonLoai.setBackground(Color.white);
        plChonTT.setBackground(Color.white);
